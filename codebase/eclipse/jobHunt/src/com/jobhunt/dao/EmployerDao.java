...
public class EmployerDao extends JobHuntDao {
	...
	public void save (User user )
	{
		...
		try
		{
			...
			PreparedStatement stmt=con.prepareStatement("insert into Employer values(?,?,?,?)");
	...
	public boolean findUser (User user){
		...
		try
		{
			...
			PreparedStatement stmt=con.prepareStatement("select * from Employer  where loginId=? and password=?");
			...
			con.close();
			System.out.println("find() of EmployerDao completed.");
		}catch(Exception e)
		{
			System.out.println(e);
