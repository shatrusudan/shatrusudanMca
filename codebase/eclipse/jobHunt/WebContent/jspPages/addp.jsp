...
<table width="372" height="293" border="0" align="center" frame="below" bordercolor="#990099">
  <tr>
    <td colspan="2"><div align="center" class="style1">Add Product <hr ></div></td>
  </tr>
  <tr>
    <td width="156">Product Id: </td>
    <td width="206">
      <label>
  ...
  <tr>
    ...
    <td><label>
      <select name="select">
        <option>Value Added Service</option>
        <option>Mail service</option>
        <option>Message service</option>
      </select>
    </label></td>
  </tr>
  <tr>
